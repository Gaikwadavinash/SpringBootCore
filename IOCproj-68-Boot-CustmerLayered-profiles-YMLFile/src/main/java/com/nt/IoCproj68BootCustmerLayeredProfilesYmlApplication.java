...
public class IoCproj68BootCustmerLayeredProfilesYmlApplication {
	@Autowired
...
ApplicationContext ctx=		SpringApplication.run(IoCproj68BootCustmerLayeredProfilesYmlApplication.class, args);
try {
BankController controller=ctx.getBean("controller",BankController.class);

CustmerVO vo= new CustmerVO("rashmi","Mumbai", "400", "2.0", "1.0");
